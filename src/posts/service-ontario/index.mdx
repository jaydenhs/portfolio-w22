...
<FullBleed>
  <Timeline start={"User visits platform"} markers={["User visits platform", "Selects type of identity card to renew", "Enters identity card information", "Answers eligibilty questions", "Pays for renewal" ]}/>
</FullBleed>