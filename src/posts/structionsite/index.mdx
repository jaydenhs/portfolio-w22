...
embeddedImagesLocal:
  ...
  - "./images/pilot-process.png"
---

import FullBleed from "@post/full-bleed-container";
import AutoLink from "@general/auto-link";
import Note from "@post/note";
import Accordion from "@post/accordion";
import Learning from "@post/learning";
import FigmaEmbed from "@post/figma-embed";
import HighlightedSection from "@post/highlighted-section";
import NumberedList from "@post/numbered-list";

import QueriedImage from "@post/image";
...
<FullBleed>
  <QueriedImage localImages={props.localImages} filename={"pilot-process"} className="w-4/5 mx-auto" />
</FullBleed>
